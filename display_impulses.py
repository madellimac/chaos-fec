...
class display_impulses(Py_Module):
	...
	def display(self, x, y, BE):#heat_map et h_ix sont des constantes
	...
	def __init__(self, H, W, heat_map, h_ix):
		...
		self.create_codelet(t_dis, lambda slf, lsk, fid: slf.display(lsk[s_x], lsk[s_y], lsk[s_BE])) # create codelet
